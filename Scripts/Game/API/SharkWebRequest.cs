...
/// SHARK用WebRequest
/// </summary>
public class SharkWebRequest<T>
{
    /// <summary>
    /// 共通レスポンスデータ
    /// </summary>
    ...
    /// construct
    /// </summary>
    public SharkWebRequest(string path)
    {
        this.path = path;
    ...
    public void Send()
    {
        ...
        TaskUpdator.Run(async () =>
        {
            ...
            {
                //タイムアウト設定
                SharkHttpClient.instance.Timeout = TimeSpan.FromSeconds(30);
                //通信開始
                var response = await SharkHttpClient.instance.PostAsync(this.url, this.content);
                //通信完了
    ...
    {
        SharedUI.Instance.ShowConnectingIndicator();
    }
    ...
    {
        SharedUI.Instance.HideConnectingIndicator();
    }
}
