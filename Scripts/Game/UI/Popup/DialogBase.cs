...
public class DialogBase : MonoBehaviour
{
    ...
    /// </summary>
    [SerializeField]
    private GameObject windowFrame = null;
    /// <summary>
    /// キャンバスグループ
    /// </summary>
    [SerializeField]
        ...
        Action onFinished)
    {
        ...
        this.windowFrame.transform.localScale = fromScale;
        ...
        while (!isFinishedAlpha || !isFinishedScale)
        {
            ...
            //スケール値更新
            this.windowFrame.transform.localScale = fromScale + (toScale - fromScale) * (1f - Mathf.Pow(2, -10 * Mathf.Clamp01(time / SCALE_DURATION)));
