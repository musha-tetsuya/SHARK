...
namespace Microsoft.VisualBasic.FileIO
{
    ...
    public class TextFieldParser : IDisposable
    {
        ...
        private string[] GetDelimitedFields()
        {
            ...
            {
                string parts = this.GetNextField(ref line, currentIndex, ref nextIndex);
        ...
        private string GetNextField(ref string line, int startIndex, ref int nextIndex)
        {
            bool inQuote = false;
            int currentindex = 0;
